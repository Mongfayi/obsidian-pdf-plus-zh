                    ...
                    const menu = new Menu()
                        ...
                        .addItem((item) => {
                            item.setSection('zoom')
                                ...
                                .setTitle(t('toolbar.fit-width', 'Fit width'))
                        ...
                        .addItem((item) => {
                            item.setSection('zoom')
                                ...
                                .setTitle(t('toolbar.fit-height', 'Fit height'))
                        ...
                        .addItem((item) => {
                            item.setSection('zoom')
                                .setIcon('lucide-move')
                                .setTitle(t('toolbar.fit-page', 'Fit page'))
                        ...
                        .addItem((item) => {
                            item.setSection('scroll')
                                ...
                                .setTitle(t('toolbar.vertical-scroll', 'Vertical scroll'))
                        ...
                        .addItem((item) => {
                            item.setSection('scroll')
                                ...
                                .setTitle(t('toolbar.in-page-scroll', 'In-page scroll'))
                        ...
                        .addItem((item) => {
                            item.setSection('scroll')
                                ...
                                .setTitle(t('toolbar.wrapped-scroll', 'Wrapped scroll'))
                        ...
                        .addItem((item) => {
                            item.setSection('spread')
                                ...
                                .setTitle(t('toolbar.single-page', 'Single page'))
                        ...
                        .addItem((item) => {
                            item.setSection("spread")
                                ...
                                .setTitle(t('toolbar.two-pages-odd', 'Two pages \(odd\)'))
                        ...
                        .addItem((item) => {
                            item.setSection('spread')
                                .setIcon('rectangle-vertical-double')
                                .setTitle(t('toolbar.two-pages-even', 'Two pages \(even\)'))
                        ...
                        .addItem((item) => {
                            item.setSection('appearance')
                                ...
                                .setTitle(t('toolbar.adapt-to-theme', 'Adapt to theme'))
                                .setChecked(isThemed)
                                .onClick(() => {
                        ...
                        .addItem((item) => {
                            item.setSection('settings')
                                ...
                                .setTitle(t('toolbar.customize-defaults', 'Customize defaults...'))
                                .onClick(() => {
