...
本仓库为 PDF++ 插件的简体中文本地化版本，基于插件的 i18n 系统实现。

## 许可证

- 本汉化版本遵循 MIT 许可证
- 详细许可证信息请参阅 [LICENSE](LICENSE) 和 [THIRD_PARTY_LICENSES](THIRD_PARTY_LICENSES)
...
如果觉得这个汉化版对你有帮助，欢迎扫码支持：

<img src="abcde.jpg" width="200" />
